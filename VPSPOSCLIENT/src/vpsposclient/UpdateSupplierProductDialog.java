...
/*
 * UpdateSupplierProductDialog.java
 *
 * Created on Nov 12, 2013, 8:41:22 PM
 */
 ...
 * @author Royal
 */
public class UpdateSupplierProductDialog extends javax.swing.JDialog {
 ArrayList<Supplier> supplierList = new Controller().getSupplierList();
 ArrayList<UOM> uomList=new Controller().getUOMList();
    static String id;
    /** Creates new form UpdateSupplierProductDialog */
    public UpdateSupplierProductDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        try {
    ...
    private void initComponents() {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(supplier, 0, 348, Short.MAX_VALUE)
                            .addComponent(product, javax.swing.GroupLayout.DEFAULT_SIZE, 348, Short.MAX_VALUE))))
                .addGap(150, 150, 150))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(322, Short.MAX_VALUE)
                .addComponent(updateProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(295, 295, 295))
        );
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {price, product, uom});
...
// TODO add your handling code here:
    try {
        ...
        if (supplierProduct.isEmpty()) {
            JOptionPane.showMessageDialog(null, "ERROR \nPlease Enter Supplier's Product");
        } else if(productPrice.isEmpty()){
            JOptionPane.showMessageDialog(null, "ERROR \nPlease Enter Product Price");
        }else if(new Controller().isInteger(productPrice.trim())==false){
            JOptionPane.showMessageDialog(null, "ERROR \nPlease Enter Product Price as Numbers");
        }
        else {
            boolean updated = new Controller().updateSupplierProduct(new SupplierProduct(id, supplierId, supplierProduct,productPrice,UOM, creationDate));
            if (updated == true) {
                JOptionPane.showMessageDialog(null, "Supplier's Product Updated successfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSupplierProductDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                UpdateSupplierProductDialog dialog = new UpdateSupplierProductDialog(new javax.swing.JFrame(), true);
    ...
    public static javax.swing.JComboBox supplier;
