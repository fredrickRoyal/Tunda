 ...
 * UpdateCashier.java
 *
 * Created on Oct 30, 2013, 9:52:42 PM
 */
...
public class UpdateCashier extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        save.setFont(new java.awt.Font("Times New Roman", 1, 18));
...
// TODO add your handling code here:
    ...
    if (firstName.getText().isEmpty() || firstName.getText().equalsIgnoreCase(" ")) {
        ...
        new Controller().updateCashier(new Cashier(id,firstName.getText(),lastName.getText(),date.getSelectedItem().toString() + "/" + month.getSelectedItem().toString() + "/" + year.getSelectedItem().toString()));
