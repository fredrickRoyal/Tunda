...
/*
 * UpdateSupplierDialog.java
 *
 * Created on Nov 10, 2013, 1:55:54 PM
 */
...
public class UpdateSupplierDialog extends javax.swing.JDialog {
    ...
    public UpdateSupplierDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addContainerGap(125, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
...
// TODO add your handling code here:
    try {
        ...
        if (name.isEmpty()) {
            ...
            boolean updated = new Controller().updateSupplier(new Supplier(id, name, createDate));
            if (updated == true) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSupplierDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                UpdateSupplierDialog dialog = new UpdateSupplierDialog(new javax.swing.JFrame(), true);
