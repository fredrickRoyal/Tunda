...
/*
 * UpdateSupplierContactDialog.java
 *
 * Created on Nov 11, 2013, 11:34:51 PM
 */
 ...
 * @author Royal
 */
public class UpdateSupplierContactDialog extends javax.swing.JDialog {

    ArrayList<Supplier> supplierList = new Controller().getSupplierList();
    static String id;

    /** Creates new form UpdateSupplierContactDialog */
    public UpdateSupplierContactDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        updateContact.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(updateContact, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
                    ...
                    .addComponent(supplier, javax.swing.GroupLayout.Alignment.LEADING, 0, 325, Short.MAX_VALUE))
                .addGap(150, 150, 150))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(37, 37, 37)
                .addComponent(updateContact, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
...
// TODO add your handling code here:
    try {
        ...
        if (supplierContact.isEmpty()) {
            ...
            boolean updated = new Controller().updateSupplierContact(new SupplierContact(id, supplierId, supplierContact, creationDate));
            if (updated == true) {
                JOptionPane.showMessageDialog(null, "Supplier's Contact Updated successfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSupplierContactDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                UpdateSupplierContactDialog dialog = new UpdateSupplierContactDialog(new javax.swing.JFrame(), true);
